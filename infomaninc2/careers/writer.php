...
<div id="content">
 ...
 <?php //$this->load->view('include/subs');?>
                ...
                <div class="main col3" align="justify">  
                 <div ><br><h2 class="hd" style="color:green;font-size:1.8em;" align="left">INFOMAN To Hire Technical Writer in the Philippines</h2><br><br>  
                    ...
                    <h2 class="hd" style="color:green;font-size:1.2em;">Qualifications</h2>                   
                           <div class="intro">
                                 ...
                                 <ul style="margin-left:30px;">
                                          <li style="font-size:1em;">A graduate of Computer Science or any related course.</li>
                                          <li style="font-size:1em;">Excellent writing skills.</li>
                                          <li style="font-size:1em;">Command of OpenOffice / MS Office and Technical English language required.</li>
                                          <li style="font-size:1em;">Experience in the development of user’s guide within IT companies is a plus.</li>
