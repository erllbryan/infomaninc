...
<div id="content">
 ...
 <?php //$this->load->view('include/subs');?>
                ...
                <div class="main col3" align="justify">  
                 <div ><br><h2 class="hd" style="color:green;font-size:1.8em;" align="left">INFOMAN To Hire Systems Analyst in the Philippines</h2><br><br>  
                    ...
                    <h2 class="hd" style="color:green;font-size:1.2em;">Qualifications</h2>                   
                           <div class="intro">
                                 ...
                                 <ul style="margin-left:30px;">
                                          <li style="font-size:1em;">Graduate of BS Computer Science, Mathematics, or other IT – related degree.</li>
                                          <li style="font-size:1em;">Knowledgeable in Java, Visual Basic, C/C++ or any modern programming language</li>
                                          <li style="font-size:1em;">At least 3 years of working experience in programming, design and analysis.</li>
                                          <li style="font-size:1em;">Knowledge of UML a plus.</li>
                                          <li style="font-size:1em;">Applicants should be willing to undergo training on standard and in-house methodologies in analysis and design.</li>
                                           <li style="font-size:1em;">Team player with good interpersonal and customer service skills.</li>
                                           <li style="font-size:1em;">Must be a fast learner and can work under pressure.</li>                        
                                </ul>
