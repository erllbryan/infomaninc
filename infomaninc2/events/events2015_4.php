            ...
            <div class="row">
              ...
              <div class="col-sm-4" style="padding:0px;margin:0px;">
                ...
                <div class="portfolio-item ">
                   ...
                   <ul class="pagination">
                      <li><a href="<?php echo base_url('events/events2015_3.php');?>">&laquo;</a></li>
                    ...
                    <li><a href="<?php echo base_url('events/events2015_2.php');?>">2</a></li>
                      ...
                      <li><a class="active" href="<?php echo base_url('events/events2015_4.php');?>">4</a></li>
                      <li><a href="<?php echo base_url('events/events2015_5.php');?>">5</a></li>
                      <li><a href="<?php echo base_url('events/events2015_6.php');?>">6</a></li> 
                      <li><a href="<?php echo base_url('events/events2015_5.php');?>">&raquo;</a></li>
                    </ul>
    </section><!--/#portfolio-->
