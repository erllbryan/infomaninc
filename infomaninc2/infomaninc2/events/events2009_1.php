        ...
        <div id="subheader">
            <div class="subheader-block group">            
                <div class="path" style="letter-spacing:1px;font-weight:bold;font-family:verdana;">
                    <ul>
                        <li class="first"><script type="text/javascript">prop1="Amadeus Home";</script><a href="<?php echo base_url('index.php');?>">Home</a></li><li><a href="<?php echo base_url('events/events2009_1.php');?>">Events</a></li><li>Progress Day 2016</li></ul>
                </div>
      ...
      <h1 style="color:green;">Progress Asia Forum 2016</h1>     <br>              
            ...
            <div class="portfolio-items">
                ...
                <div class="portfolio-item ">
                    ...
                    <ul class="pagination">
                      <li><a href="<?php echo base_url('events/events2009_1.php');?>">&laquo;</a></li>
                      <li><a  class="active" href="<?php echo base_url('events/events2009_1.php');?>">1</a></li>
                      ...
                      <li><a href="<?php echo base_url('events/events2009_2.php');?>">&raquo;</a></li>
                    </ul>
    </section><!--/#portfolio-->
