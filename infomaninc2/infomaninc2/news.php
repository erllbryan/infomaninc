...
<div id="content">
        ...
        <div id="subheader">
            <div class="subheader-block group">            
                <div class="path" style="letter-spacing:1px;font-weight:bold;font-family:verdana;">
                    <ul>
                        <li class="first"><a href="<?php echo base_url('home');?>">Home</a></li><li ><a href="<?php echo base_url('partners');?>">Partners</a></li><li>QAD Community Trends</li></ul>
                </div>
 ...
 <?php //$this->load->view('include/sub_nav');?>
                   ...
                   <div class="main col3">
                          <div class="intro">  
                                    <a class="twitter-timeline" data-height="700" href="https://twitter.com/QAD_Community">News by QAD_Community</a> <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
