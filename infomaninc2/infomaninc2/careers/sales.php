...
<div id="content">
 ...
 <?php //$this->load->view('include/subs');?>
                ...
                <div class="main col3" align="justify">  
                 <div ><br><h2 class="hd" style="color:green;font-size:1.8em;" align="left">INFOMAN to hire Sales and Marketing Staff in the philippines</h2><br><br>  
                    ...
                    <h2 class="hd" style="color:green;font-size:1.2em;">Qualifications</h2>                   
                           <div class="intro">
                                 ...
                                 <ul style="margin-left:30px;">
                                          <li style="font-size:1em;">Candidate must be a graduate of any (4) - year course. </li>
                                          <li style="font-size:1em;">Preferably female: 21-28 yrs. old.</li>
                                          <li style="font-size:1em;">Must be knowledgeable in business documents (business letters).</li>
                                          <li style="font-size:1em;">Must be able to handle corporate sales and marketing </li>
                                          <li style="font-size:1em;">Must be keen to details and flexible</li>
                                          <li style="font-size:1em;">Must possess good interpersonal skills </li>   
                                          <li style="font-size:1em;">Full time position available.</li>                         
                                </ul>
