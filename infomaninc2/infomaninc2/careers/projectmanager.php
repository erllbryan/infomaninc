...
<div id="content">
 ...
 <?php //$this->load->view('include/subs');?>
                ...
                <div class="main col3" align="justify">  
                 <div ><br><h2 class="hd" style="color:green;font-size:1.8em;" align="left">INFOMAN To Hire Project Manager in the Philippines</h2><br><br>  
                    ...
                    <h2 class="hd" style="color:green;font-size:1.2em;">Qualifications</h2>                   
                           <div class="intro">
                                 ...
                                 <ul style="margin-left:30px;">
                                          ...
                                          <li style="font-size:1em;">Minimum of 5 years experience in managing software development projects.</li>
